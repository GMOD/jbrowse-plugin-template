...
This avoids needing a specialized CSS loader in either rollup or esbuild. Other approaches are possible — for example, configuring a rollup/esbuild CSS plugin to inline styles into the bundle.
